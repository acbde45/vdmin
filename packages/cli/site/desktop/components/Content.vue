<template>
  <div
    :class="['vdmin-doc-content', `vdmin-doc-content--${currentPage}`]"
    @click="onClick"
  >
    <slot />
  </div>
...
export default {
  ...
  methods: {
    ...
    copyAction() {
      const codeBoxes = document.querySelectorAll('.vdmin-doc-card pre code');
...
.vdmin-doc-card {
  ...
  > blockquote a {
    margin: 0 1px;
    color: $--vdmin-doc-blue;
    -webkit-font-smoothing: auto;

    &:hover {
      color: darken($--vdmin-doc-blue, 10%);
    }

    &:active {
      color: darken($--vdmin-doc-blue, 20%);
    }
  }
  ...
  > table {
    ...
    td {
      padding: 8px;
      border-top: 1px solid $--vdmin-doc-code-background-color;
      ...
      &:first-child {
        ...
        code {
          ...
          font-weight: 600;
          font-size: 11px;
          background-color: fade($--vdmin-doc-blue, 10%);
          border-radius: 20px;
        }
      }
    ...
    em {
      ...
      font-size: 14px;
      font-family: $--vdmin-doc-code-font-family;
      font-style: normal;
      max-width: 300px;
      -webkit-font-smoothing: auto;
    }
  ...
  > ol li {
    ...
    &::before {
      ...
      height: 6px;
      margin-top: 10px;
      border: 1px solid $--vdmin-doc-dark-grey;
      border-radius: 50%;
      content: '';
    }
  }
